...
export default function PredictionsPage() {
    ...
    return (
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <EmptyState
          ...
          description="Run your first inflation forecast to see active predictions, confidence trends, and AI commentary here."
        />
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      {/* Forecast timeline from latest active prediction */}
